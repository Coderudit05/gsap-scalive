...
2. [How to Include GSAP](#how-to-include-gsap)
3. [gsap.to()](#gsapto)
   - [Syntax](#syntax-for-to)
   - [Example — Basic Animation](#example--basic-animation-to)
   - [Special Properties Explained](#special-properties-explained-to)
4. [gsap.from()](#gsapfrom)
   - [Syntax](#syntax-for-from)
   - [Example — Basic Animation](#example--basic-animation-from)
5. [gsap.to() vs gsap.from()](#gsapto-vs-gsapfrom)
6. [Stagger](#stagger)
...
- Think of it as: *"Animate FROM the current state TO these values."*
...
- Think of it as: *"Animate FROM these values TO the current state."*
...
/* All 6 boxes share the same class */
.box {
    height: 100px;
    width: 100px;
...
.box {
    ...
    width: 100px;
    background-color: violet;
    margin: 10px; /* gap between each box */
}
```
...
> 📌 **More topics coming soon:** `gsap.fromTo()`, `gsap.timeline()`, ScrollTrigger, and more.